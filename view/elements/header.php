        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex me-auto col-lg-4 mt-3 mt-lg-0" role="search">
                    <input class="form-control me-2" type="search" placeholder="Rechercher" aria-label="Barre de recherche">
                ...
                <div class="d-flex flex-column flex-lg-row">
                    ...
                    <?php else : ?>
                        ...
                        <?php if (isAdmin()) : ?>
                            <a href="" class="btn btn-light me-lg-2 px-4 mt-1 mt-lg-0">
                        ...
                        <?php if (isAnnouncer()) : ?>
                            <a href="<?= $router->generate('mesannonces') ?>" class="btn btn-warning me-lg-2 px-4 mt-1 mt-lg-0">

...
<div class="row flex-nowrap">
    <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 nav-color position-fixed" ><!--position-fixed-->
        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 min-vh-100">
            ...
            <span class="fs-5 d-none d-md-inline text-white">Gestion des annonces</span>
            
            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start">

                <li class="nav-item">
                    <a href="<?= $router->generate('mesannonces') ?>" class="nav-link align-middle px-0 text-white" >
                    
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-megaphone" viewBox="0 0 16 16">
                        ...
                        <span class="d-none d-md-inline">&#160;Vos annonces</span>
                    </a>
                </li>

                <li>
                    <a href="<?= $router->generate('nouvannonce') ?>" class="nav-link px-0 align-middle text-white">
                        ...
                        <span class="d-none d-md-inline">&#160;Nouvelle annonce</span>
                    </a>
                </li>
            </ul>
        </div>
